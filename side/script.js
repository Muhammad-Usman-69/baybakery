...
window.addEventListener("scroll", () => {
  ...
  if (
    window.scrollY >=
    document.body.clientHeight - (nav.clientHeight + footer.clientHeight)
  ) {
...
if (document.body.clientWidth > categoryContainer.scrollWidth) {
  navScrollers.forEach(navScroller => navScroller.classList.add("hidden"));
} 
