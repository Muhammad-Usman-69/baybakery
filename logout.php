...
<body class="open-sans bg-gray-50">
  ...
  <div class="max-w-md mx-auto min-h-screen flex flex-col items-center justify-center" method="post"
    action="partials/_login.php">
    <p id="helper-text-explanation" class="mb-5 text-sm text-gray-500 dark:text-gray-400">Are you sure you want to log out?</p>
    <a href="partials/_logout"
